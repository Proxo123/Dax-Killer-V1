return function(Dax)
    ...
    addLabel(aimPage,"-- bullet redirect --")
    addCheck(aimPage,"redirect enabled",function() return Config.Combat.RedirectEnabled end,function(v) Config.Combat.RedirectEnabled=v end)
    addCheck(aimPage,"redirect team check",function() return Config.Combat.RedirectTeamCheck end,function(v) Config.Combat.RedirectTeamCheck=v end)
    addSlider(aimPage,"redirect max dist",50,2000,function() return Config.Combat.RedirectMaxDist end,function(v) Config.Combat.RedirectMaxDist=v end," st")
