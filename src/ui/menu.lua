return function(Dax)
    ...
    addLabel(aimPage,"-- silent aim --")
    addCheck(aimPage,"silent aim",function() return Config.Combat.SilentAim end,function(v) Config.Combat.SilentAim=v App.SilentTarget=nil end)
    addCheck(aimPage,"silent target tracer",function() return Config.Combat.SilentTracer end,function(v) Config.Combat.SilentTracer=v end)
    ...
    addCheck(modsPage,"infinite ammo",function() return Config.Weapons.InfiniteAmmo end,function(v) Config.Weapons.InfiniteAmmo=v if Dax.Features.Weapons then Dax.Features.Weapons.sync() end end)
